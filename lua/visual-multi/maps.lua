...
function M._build_permanent_maps()
  ...
  vim.g.Vm.leader = type(ldr) == 'string'
      and {default = ldr, visual = ldr, buffer = ldr}
...
function M._check_warnings()
  ...
  if vim.g.VM_show_warnings == 1
      and vim.b.VM_Debug
      and vim.b.VM_Debug.lines
      and #vim.b.VM_Debug.lines > 0
      and not vim.b.VM_Debug.maps_warning then
