...
Themes._dark = {'iceblue', 'ocean', 'neon', 'purplegray', 'nord', 'codedark', 'spacegray', 'olive', 'sand'}
...
function M.init()
  if not vim.g.Vm then return end
...
function M.statusline()
  ...
  return string.format('%s %s %s %s %s%s %s %%=%%l:%%c %s %s',
